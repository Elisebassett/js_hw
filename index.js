...
// Declare a function that lets you choose which door to open of 3 doors (like the TV game show). Behind one of the doors is a goat, behind another is a Jeep, and behind another is a can of worms. Alert the user which prize they got when a door number is passed in.
